        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-center">
                    <h2>Gestionar sistema</h2><span class="ms-2">
                </div>
    ...
    <nav class="navbar navbar-expand-md navbar-dark custom-color">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="#London" onclick="openTab(event, 'London')">Usuarios</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#Paris" onclick="openTab(event, 'Paris')">Categorías y servicios</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#Tokyo" onclick="openTab(event, 'Tokyo')">Especialidad y peluqueros</a>
                    </li>
                    <li class="nav-item">
